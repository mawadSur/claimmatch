...
export const SAMPLE_LAWSUITS: Lawsuit[] = [
  ...
  },
  {
    ...
    estimated_value_min: 40,
    estimated_value_max: 500,
    proof_required: false,
    deadline: iso(80),
  ...
  },
  {
    ...
    estimated_value_min: 30,
    estimated_value_max: 400,
    proof_required: false,
    deadline: iso(20),
