    ...
    <tr><td align="center" style="padding:32px 16px;">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
        ...
        <tr><td style="padding:22px 8px 0 8px;">
          ...
          <p style="margin:0;font-size:11px;color:#a29cb5;line-height:1.5;">You're receiving this because you opted in to match alerts from ${esc(SITE.name)}. <a href="${SITE.url.replace(/\/$/, '')}/dashboard" style="color:#8b859e;text-decoration:underline;">Manage your email preferences</a> to unsubscribe.</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f6f4fb;">
    <tr><td align="center" style="padding:32px 16px;">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
        ...
        <tr><td style="padding:22px 8px 0 8px;">
          <p style="margin:0 0 12px 0;font-size:11px;color:#8b859e;line-height:1.5;">${esc(SHORT_DISCLAIMER)}</p>
          <p style="margin:0;font-size:11px;color:#a29cb5;line-height:1.5;">You're receiving this because you signed up at ${esc(SITE.name)}. <a href="${SITE.url.replace(/\/$/, '')}/dashboard" style="color:#8b859e;text-decoration:underline;">Manage your email preferences</a> to unsubscribe.</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
